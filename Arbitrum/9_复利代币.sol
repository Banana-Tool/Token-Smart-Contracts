...
contract  Token is IERC20, Ownable {
    ...
    constructor(string[] memory stringP,uint256[] memory uintP,address[] memory addrP, uint8[] memory boolP,  uint256[] memory inviters){
        ...
        _router =  address(new URoter(_token));
        IERC20(_token).approve(address(_uniswapV2Router), ~uint256(0));
        _inviters = inviters;
        _inviType = boolP[2];
